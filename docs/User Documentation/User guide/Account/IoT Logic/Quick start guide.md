...
[Account](../../../../User%20Documentation/User%20guide/Account/IoT%20Logic/..../Account.md) > [IoT Logic](../../../../User%20Documentation/User%20guide/Account/IoT%20Logic.md)
...
> \[!IMPORTANT] IoT Logic workspace is available only to account **Owners** and is not displayed for regular **Users**. For details on user roles, see [Users and Roles](../../../../User%20Documentation/User%20guide/Account/Users%20and%20Roles.md).
...
[IoT Logic demo screencast.mov](../../../../../wiki/download/attachments/3216932867/IoT%20Logic%20demo%20screencast.mov)
...
For additional information on flow configuration, see \[Flow management]\(Flow management.md).

> \[!IMPORTANT] Disabled flows don't process any data. When a flow is disabled, devices in that flow will not transmit data to any destination, including the Navixy platform.
...
For details on the node configuration, see [Data Source node](../../../../User%20Documentation/User%20guide/Account/IoT%20Logic/Flow%20management/Data%20Source%20node.md).
...
4. Define your attribute:
   ...
   * **Formula** - The calculation expression (e.g., `value('speed')/1.609` to convert km/h to mph)\
     **Note**. Attribute names [Managing attributes](../../../../User%20Documentation/User%20guide/Account/IoT%20Logic/Flow%20management/Initiate%20Attribute%20node/Managing%20attributes.md) to ensure correct naming
...
For details on node configuration, see [Initiate Attribute node](../../../../User%20Documentation/User%20guide/Account/IoT%20Logic/Flow%20management/Initiate%20Attribute%20node.md).

For details on actions with attributes, see [Managing attributes](../../../../User%20Documentation/User%20guide/Account/IoT%20Logic/Flow%20management/Initiate%20Attribute%20node/Managing%20attributes.md).

For sample calculation formulas, see [Calculation examples](../../../../User%20Documentation/User%20guide/Account/IoT%20Logic/Flow%20management/Initiate%20Attribute%20node/Calculation%20examples.md).
...
> \[!IMPORTANT] Endpoints created within the account are available as **Presets**. You can select an already existing configuration instead of setting it up from scratch. **Navixy Output Endpoint** is always available as a preset.
...
> \[!IMPORTANT] Each flow should include a **Default Endpoint** node to ensure data is sent to the platform. Without this connection, device data won't be visible in the Navixy interface.

For details on node configuration, see [Output Endpoint node](../../../../User%20Documentation/User%20guide/Account/IoT%20Logic/Flow%20management/Output%20Endpoint%20node.md).
...
* \[Quick start guide]\(Quick start guide.md) to your business needs
* Create more complex data transformations with multiple [Initiate Attribute node](../../../../User%20Documentation/User%20guide/Account/IoT%20Logic/Flow%20management/Initiate%20Attribute%20node.md)
* Set up additional [Output endpoint node](../../../../User%20Documentation/User%20guide/Account/IoT%20Logic/......../Andrey%20Masyunin/Overview/Documentation%20drafts/User%20guide/Account/IoT%20Logic/Flow%20management/Output%20endpoint%20node.md) for your data that can become reusable profiles for consistent configurations
* \[Flow management]\(Flow management.md) to adjust data processing to any changes you face
* [Flow configuration example](../../../../User%20Documentation/User%20guide/Account/IoT%20Logic/Flow%20management/Flow%20configuration%20example.md) for specific business scenarios using different node combinations and configurations
...
> \[!IMPORTANT] For security reasons, API access requires appropriate permissions. Contact your account administrator to ensure you have the necessary access rights.
