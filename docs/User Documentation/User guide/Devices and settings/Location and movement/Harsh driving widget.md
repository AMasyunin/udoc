...
[Devices and settings](..\..\Devices%20and%20settings.md) > [Location and movement](..\Location%20and%20movement.md)

# Harsh driving widget

Many advanced vehicle GPS devices feature a built-in **harsh driving detector**. This detector continuously monitors acceleration values during acceleration, braking, and turning. When these values exceed predefined thresholds, the system generates a corresponding "Harsh driving" event. These events can be tracked and analyzed using [Harsh driving](..\..\Rules%20and%20notifications\Safety\Harsh%20driving.md) and [Eco Driving](..\..\Fleet%20management\Eco%20Driving.md), allowing for a detailed assessment of driving behavior.
...
![image-20240815-214000.png](..\..\..\attachments\e0c9816a-698a-46da-9f9c-3d28cc862352.png)
