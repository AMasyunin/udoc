...
[Rules and notifications](..\..\Rules%20and%20notifications.md) > [Safety](..\Safety.md)
...
No other specific settings are required for this rule. For common settings, please refer to [Rules and notifications](..\..\Rules%20and%20notifications.md).
