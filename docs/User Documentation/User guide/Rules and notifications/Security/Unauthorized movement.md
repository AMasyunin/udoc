...
[Rules and notifications](..\..\Rules%20and%20notifications.md) > [Security](..\Security.md)
...
There are no specific settings to configure within the rule itself. For common settings, please refer to [Rules and notifications](..\..\Rules%20and%20notifications.md).
