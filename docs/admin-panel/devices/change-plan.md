...
3. You will have the option to choose how to charge the user with monthly-based plans. There are two options:
  1. Repay remainder of current plan payment: Select this option if you want to charge the user (according to the current plan) up to the end of the month.
...
For further details on Plans, please see our documentation [here](../../admin-panel/plans.md).