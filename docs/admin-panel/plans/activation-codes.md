...
![Activation codes](./attachments/1%20234%20567%20890%20(1)-20230811-205456.png)
...
You are able to have an activation code associated with a [device plan](../plans.md), so when a user does activate a device it’s automatically setup with what they should have access to.
