...
For instruction on using the API, please see our documentation here: [Custom menu on Developers portal](https://developers.navixy.com/panel-api/resources/user/menu/preset/)