...
This is the most convenient and inexpensive method. More information on GIS packages can be found here: [Maps](../maps.md)
...
More information on Nominatim can be found here: [Nominatim](https://squaregps.atlassian.net/wiki/spaces/Ponprem/pages/2352152625/Nominatim)
