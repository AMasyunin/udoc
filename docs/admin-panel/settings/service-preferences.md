...
2. [Regional settings](./service-preferences/regional-settings.md): Choose the language and currency for your service.
3. Login page settings: Configure your login page.
4. [Demo user account](./service-preferences/demo-user-account.md): Navixy allows you to create a demo user account to showcase the platform's features to your customers.
