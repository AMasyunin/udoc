...
Alternatively, it is possible to delete a user account through the Navixy API by using the [corrupt()](https://developers.navixy.com/panel-api/resources/user/#corrupt) call.