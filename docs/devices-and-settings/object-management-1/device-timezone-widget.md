...
> \[!WARNING] Navixy strongly recommends keeping the device set to UTC+0h as the standard timezone setting to ensure consistency and accuracy in tracking data. However, if your device is configured with a different timezone, this widget allows you to make the necessary adjustments.
