...
To delete a row, click ![](<../../../.gitbook/assets/image (1) (1) (1) (1).png>).

![Measurement sensor](https://www.navixy.com/wp-content/uploads/2021/10/measurement_sensor_calibration_table_en.png)

To upload the calibration table file, click ![](<../../../.gitbook/assets/image (2) (1).png>). Calibration files can be generated by Omnicomm LLS Monitor utility. Only XML file format is supported.

![](https://www.navixy.com/wp-content/uploads/2021/10/upload_calibration_table_en.png)

For more precise setting, click "Advanced settings" button ![](<../../../.gitbook/assets/image (3) (1).png>). These settings are Ignore values and Multiplier.
